...
## [Unreleased]
### Added
- Dynamic icons for audio and backlight feature (see `icons` setting in the respective feature documentation).
...
[Unreleased]: https://github.com/Gerschtli/dwm-status/compare/1.2.0...HEAD
